...
extern (D) auto VK_VERSION_MAJOR(T)(auto ref T v)
{
    return cast(uint) v >> 22;
}

extern (D) auto VK_VERSION_MINOR(T)(auto ref T v)
{
    return (cast(uint) v >> 12) & 0x3ff;
}

extern (D) auto VK_VERSION_PATCH(T)(auto ref T v)
{
    return cast(uint) v & 0xfff;
}

// Version of this file
enum VK_HEADER_VERSION = 126;
...
alias VkShaderModuleCreateFlagBits = uint;
...
alias VkPipelineShaderStageCreateFlagBits = uint;
...
alias VkFramebufferCreateFlagBits = uint;
...
alias VkRenderPassCreateFlagBits = uint;
...
alias VkShaderFloatControlsIndependenceKHR = uint;
...
alias VkSemaphoreWaitFlagBitsKHR = uint;
...
alias PFN_vkWaitSemaphoresKHR = VkResult function(VkDevice device, const(VkSemaphoreWaitInfoKHR)* pWaitInfo, ulong timeout);
alias PFN_vkSignalSemaphoreKHR = VkResult function(VkDevice device, const(VkSemaphoreSignalInfoKHR)* pSignalInfo);

VkResult vkGetSemaphoreCounterValueKHR(VkDevice device, VkSemaphore semaphore, ulong* pValue);
VkResult vkWaitSemaphoresKHR(VkDevice device, const(VkSemaphoreWaitInfoKHR)* pWaitInfo, ulong timeout);
VkResult vkSignalSemaphoreKHR(VkDevice device, const(VkSemaphoreSignalInfoKHR)* pSignalInfo);
...
VkResult vkGetPipelineExecutablePropertiesKHR(VkDevice device, const(VkPipelineInfoKHR)* pPipelineInfo, uint* pExecutableCount, VkPipelineExecutablePropertiesKHR* pProperties);
VkResult vkGetPipelineExecutableStatisticsKHR(VkDevice device, const(VkPipelineExecutableInfoKHR)* pExecutableInfo, uint* pStatisticCount, VkPipelineExecutableStatisticKHR* pStatistics);
VkResult vkGetPipelineExecutableInternalRepresentationsKHR(VkDevice device, const(VkPipelineExecutableInfoKHR)* pExecutableInfo, uint* pInternalRepresentationCount, VkPipelineExecutableInternalRepresentationKHR* pInternalRepresentations);
...
VkResult vkCreateRayTracingPipelinesNV(VkDevice device, VkPipelineCache pipelineCache, uint createInfoCount, const(VkRayTracingPipelineCreateInfoNV)* pCreateInfos, const(VkAllocationCallbacks)* pAllocator, VkPipeline* pPipelines);
...
void vkCmdWriteAccelerationStructuresPropertiesNV(VkCommandBuffer commandBuffer, uint accelerationStructureCount, const(VkAccelerationStructureNV)* pAccelerationStructures, VkQueryType queryType, VkQueryPool queryPool, uint firstQuery);
...
alias VkPipelineCompilerControlFlagBitsAMD = uint;
...
alias VkPerformanceConfigurationTypeINTEL = uint;
...
alias VkQueryPoolSamplingModeINTEL = uint;
...
alias VkPerformanceOverrideTypeINTEL = uint;
...
alias VkPerformanceParameterTypeINTEL = uint;
...
alias VkPerformanceValueTypeINTEL = uint;
...
alias VkShaderCorePropertiesFlagBitsAMD = uint;
...
VkResult vkGetPhysicalDeviceSupportedFramebufferMixedSamplesCombinationsNV(VkPhysicalDevice physicalDevice, uint* pCombinationCount, VkFramebufferMixedSamplesCombinationNV* pCombinations);
...
alias VkLineRasterizationModeEXT = uint;
...
void vkCmdSetLineStippleEXT(VkCommandBuffer commandBuffer, uint lineStippleFactor, ushort lineStipplePattern);
